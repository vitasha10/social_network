...
final class DialogOptions {
    ...
    private int titleResId = com.isocial.webview.R.string.rate_dialog_title;

    private int messageResId = com.isocial.webview.R.string.rate_dialog_message;

    private int textPositiveResId = com.isocial.webview.R.string.rate_dialog_ok;

    private int textNeutralResId = com.isocial.webview.R.string.rate_dialog_cancel;

    private int textNegativeResId = com.isocial.webview.R.string.rate_dialog_no;
