...
public class MainActivity extends AppCompatActivity {
    ...
    private static String ASWV_URL      = "http://www.kanorika.com/isocial/demo"; //complete URL of your website or webpage
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent intent) {
        ...
        if (Build.VERSION.SDK_INT >= 21) {
            ...
            getWindow().setStatusBarColor(getResources().getColor(com.isocial.webview.R.color.colorPrimary));
            Uri[] results = null;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.isocial.webview.R.layout.activity_main);

        if (ASWP_PBAR) {
            asw_progress = (ProgressBar) findViewById(com.isocial.webview.R.id.msw_progress);
        } else {
            findViewById(com.isocial.webview.R.id.msw_progress).setVisibility(View.GONE);
        }
        asw_loading_text = (TextView) findViewById(com.isocial.webview.R.id.msw_loading_text);
        ...
        asw_view = (WebView) findViewById(com.isocial.webview.R.id.msw_view);
        ...
        if (Build.VERSION.SDK_INT >= 21) {
            getWindow().addFlags(WindowManager.LayoutParams.FLAG_DRAWS_SYSTEM_BAR_BACKGROUNDS);
            getWindow().setStatusBarColor(getResources().getColor(com.isocial.webview.R.color.colorPrimaryDark));
    ...
    public void onResume() {
        ...
        if (Build.VERSION.SDK_INT >= 23) {
            Bitmap bm = BitmapFactory.decodeResource(getResources(), com.isocial.webview.R.mipmap.ic_launcher);
            ActivityManager.TaskDescription taskDesc = null;
            taskDesc = new ActivityManager.TaskDescription(getString(com.isocial.webview.R.string.app_name), bm, getColor(com.isocial.webview.R.color.colorPrimary));
	...
	private class Callback extends WebViewClient {
        ...
        public void onPageFinished(WebView view, String url) {
            findViewById(com.isocial.webview.R.id.msw_welcome).setVisibility(View.GONE);
            findViewById(com.isocial.webview.R.id.msw_view).setVisibility(View.VISIBLE);
        }
    ...
    public void get_rating() {
        if (DetectConnection.isInternetAvailable(MainActivity.this)) {
            AppRate.with(this)
                ...
                .setTitle(com.isocial.webview.R.string.rate_dialog_title)
                .setMessage(com.isocial.webview.R.string.rate_dialog_message)
                .setTextLater(com.isocial.webview.R.string.rate_dialog_cancel)
                .setTextNever(com.isocial.webview.R.string.rate_dialog_no)
                .setTextRateNow(com.isocial.webview.R.string.rate_dialog_ok)
                .monitor();
    ...
    public void show_notification(int type, int id) {
        ...
        switch(type){
            case 1:
                builder.setTicker(getString(com.isocial.webview.R.string.app_name));
                builder.setContentTitle(getString(com.isocial.webview.R.string.loc_fail));
                builder.setContentText(getString(com.isocial.webview.R.string.loc_fail_text));
                builder.setStyle(new NotificationCompat.BigTextStyle().bigText(getString(com.isocial.webview.R.string.loc_fail_more)));
                builder.setVibrate(new long[]{350,350,350,350,350});
                builder.setSmallIcon(com.isocial.webview.R.mipmap.ic_launcher);
            break;

            case 2:
                builder.setTicker(getString(com.isocial.webview.R.string.app_name));
                builder.setContentTitle(getString(com.isocial.webview.R.string.app_name));
                builder.setContentText(getString(com.isocial.webview.R.string.loc_perm_text));
                builder.setStyle(new NotificationCompat.BigTextStyle().bigText(getString(com.isocial.webview.R.string.loc_perm_more)));
		...
		switch (requestCode){
			case 1: {
				if(grantResults.length > 0 && grantResults[0] == PackageManager.PERMISSION_GRANTED){
					...
					show_notification(2, 2);
					Toast.makeText(MainActivity.this, com.isocial.webview.R.string.loc_req, Toast.LENGTH_LONG).show();
				}
			}
		}
	}
